Public Delegate Sub InitEvent(ByVal sender As Object, ByVal param As InitParam)

Public Class PluginForm
    Inherits System.Windows.Forms.Form
    Implements IPlugin

    Private m_RetValue As Object

    Public Event Init As InitEvent
...
#End Region
    ...
    Public Sub Initialize(ByVal sender As Object, ByVal param As InitParam) Implements IPlugin.Initialize
        RaiseEvent Init(sender, param)
    End Sub

    Public Property RetValue() As Object Implements IPlugin.RetValue
        Get
            Return m_RetValue
        End Get
