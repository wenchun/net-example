...
Public Class EmpDataSet
    ...
    Private Sub InitClass()
        ...
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/EmpDataSet.xsd"
    ...
    Public Class EmployeesDataTable
        ...
        Private column員工編號 As DataColumn
        
        Private columnLastName As DataColumn
        
        Private columnFirstName As DataColumn
        
        Private column職稱 As DataColumn
        
        Private columnTitleOfCourtesy As DataColumn
        
        Private column出生日期 As DataColumn
        
        Private column到職日期 As DataColumn
        ...
        Friend ReadOnly Property 員工編號Column As DataColumn
            Get
        ...
        Friend ReadOnly Property 職稱Column As DataColumn
            Get
                Return Me.column職稱
            End Get
        End Property
        ...
        Friend ReadOnly Property 出生日期Column As DataColumn
            Get
                Return Me.column出生日期
            End Get
        End Property
        
        Friend ReadOnly Property 到職日期Column As DataColumn
            Get
                Return Me.column到職日期
            End Get
        End Property
        ...
        Public Overloads Function AddEmployeesRow( _
            ...
            rowEmployeesRow.ItemArray = New Object() {Nothing, LastName, FirstName, 職稱, TitleOfCourtesy, 出生日期, 到職日期, Address, City, _Region, PostalCode, Country, HomePhone, Extension, Photo, Notes, ReportsTo, PhotoPath}
            Me.Rows.Add(rowEmployeesRow)
            Return rowEmployeesRow
        End Function
        
        Public Function FindBy員工編號(ByVal 員工編號 As Integer) As EmployeesRow
            Return CType(Me.Rows.Find(New Object() {員工編號}),EmployeesRow)
        End Function
        ...
        Friend Sub InitVars()
            ...
            Me.column出生日期 = Me.Columns("出生日期")
            Me.column到職日期 = Me.Columns("到職日期")
        ...
        Private Sub InitClass()
            Me.column員工編號 = New DataColumn("員工編號", GetType(System.Int32), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.column員工編號)
            ...
            Me.column出生日期 = New DataColumn("出生日期", GetType(System.DateTime), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.column出生日期)
            Me.column到職日期 = New DataColumn("到職日期", GetType(System.DateTime), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.column到職日期)
            ...
            Me.Constraints.Add(New UniqueConstraint("Constraint1", New DataColumn() {Me.column員工編號}, true))
            Me.column員工編號.AutoIncrement = true
            Me.column員工編號.AllowDBNull = false
            Me.column員工編號.ReadOnly = true
    ...
    Public Class EmployeesRow
        ...
        Public Property 員工編號 As Integer
            Get
                Return CType(Me(Me.tableEmployees.員工編號Column),Integer)
            End Get
            Set
                Me(Me.tableEmployees.員工編號Column) = value
            End Set
        End Property
        ...
        Public Property 職稱 As String
            Get
                Try 
                    Return CType(Me(Me.tableEmployees.職稱Column),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableEmployees.職稱Column) = value
            End Set
        End Property
        ...
        Public Property 出生日期 As Date
            Get
                Try 
                    Return CType(Me(Me.tableEmployees.出生日期Column),Date)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableEmployees.出生日期Column) = value
            End Set
        End Property
        
        Public Property 到職日期 As Date
            Get
                Try 
                    Return CType(Me(Me.tableEmployees.到職日期Column),Date)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableEmployees.到職日期Column) = value
            End Set
        End Property
        ...
        Public Function Is職稱Null() As Boolean
            Return Me.IsNull(Me.tableEmployees.職稱Column)
        End Function
        
        Public Sub Set職稱Null()
            Me(Me.tableEmployees.職稱Column) = System.Convert.DBNull
        End Sub
        ...
        Public Function Is出生日期Null() As Boolean
            Return Me.IsNull(Me.tableEmployees.出生日期Column)
        End Function
        
        Public Sub Set出生日期Null()
            Me(Me.tableEmployees.出生日期Column) = System.Convert.DBNull
        End Sub
        
        Public Function Is到職日期Null() As Boolean
            Return Me.IsNull(Me.tableEmployees.到職日期Column)
        End Function
        
        Public Sub Set到職日期Null()
            Me(Me.tableEmployees.到職日期Column) = System.Convert.DBNull
        End Sub
